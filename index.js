...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Así vas a ser conmigo?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Solo piensalooo un poquito';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'Que firmeeee así va a serrrrr?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 14:
            ...
            document.getElementById('noBtn').innerHTML = 'NoOoOoO... ya di que sií';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = 'El Real Madrid es mejor que el VARcelona';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
